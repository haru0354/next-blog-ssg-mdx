...
const page = () => {
  return (
    <div className="content p-4 bg-white">
      <h2 className="text-xl font-semibold text-white my-6 p-4 bg-gray-800 rounded">プライバシーポリシー</h2>
      このプライバシーポリシーは、「<Link href="/" className="text-sky-600">当サイト</Link>」
      の利用に関する情報収集、利用、および開示に関する方針を説明します。
      <h3 className="text-lg font-semibold my-6 p-2 border-b-2 border-gray-700">アクセス解析ツールについて</h3>
      <p className="mb-4">
      ...
      <h3 className="text-lg font-semibold my-6 p-2 border-b-2 border-gray-700">広告について</h3>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold text-white my-6 p-4 bg-gray-800 rounded">免責事項</h2>
      <h3 className="text-lg font-semibold my-6 p-2 border-b-2 border-gray-700">情報の正確性</h3>
      <p className="mb-4">
      ...
      <p className="mb-4">ユーザーは個別の状況に応じて専門家に相談することをお勧めします。</p>
      <h3 className="text-lg font-semibold my-6 p-2 border-b-2 border-gray-700">責任の制限</h3>
      <p>
      ...
      <h3 className="text-lg font-semibold my-6 p-2 border-b-2 border-gray-700">外部リンク</h3>
      <p className="mb-4">
