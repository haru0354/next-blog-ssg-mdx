...
import { getThirdLevelArticle, getThirdLevelArticles } from "@/app/component/lib/ThirdLevelArticleService";
...
export async function generateStaticParams() {
  ...
  const Page = async ({
    ...
    params: { firstLevelArticle_slug: string; secondLevelArticle_slug: string; thirdLevelArticle_slug: string; };
  }) => {
